...
import { Check, Link2, Loader2, Swords, Backpack, Sparkles, User, ScrollText, RotateCcw, Users } from 'lucide-react'
...
export function WizardProgress({ currentStep, totalSteps }: WizardProgressProps) {
  const { completedSteps, goToStep, reset } = useWizardStore()
  ...
  return (
    <div className="mb-8">
      {/* Current step badge with restart button */}
      <div className="flex items-center justify-center gap-3 mb-6">
        ...
        <button
          ...
          className="p-2.5 rounded-full bg-card border border-border hover:border-red-500/50 hover:bg-red-500/10 text-muted-foreground hover:text-red-500 transition-all shadow-lg group"
