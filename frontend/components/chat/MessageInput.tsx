  ...
  return (
    <div className="p-4">
      <form onSubmit={handleSubmit} className="relative">
        ...
        {/* Helper text */}
        <div
          id="message-input-helper"
          className="flex items-center justify-between mt-2 px-2 text-xs text-muted-foreground/60"
        >
          <span>
            Press <kbd className="inline-flex h-5 items-center rounded border bg-muted px-1.5 font-mono text-[10px] font-medium text-muted-foreground">Enter</kbd> to send, <kbd className="inline-flex h-5 items-center rounded border bg-muted px-1.5 font-mono text-[10px] font-medium text-muted-foreground">Shift</kbd>+<kbd className="inline-flex h-5 items-center rounded border bg-muted px-1.5 font-mono text-[10px] font-medium text-muted-foreground">Enter</kbd> for new line
          </span>
