...
class RulebookStorage:
    ...
    def generate_embeddings(self, batch_size: int = 50, use_contextual: bool = True) -> None:
        ...
        if use_contextual and CONTEXTUAL_PREFIXES_PATH.exists():
            ...
            print(f"📖 Loaded {len(contextual_prefixes)} contextual prefixes for improved retrieval")
            ...
            print("⚠️  No contextual prefixes found. Run 'uv run python -m scripts.build_contextual_embeddings' first.")
    ...
    def load_contextual_prefixes(self) -> int:
        ...
        if not CONTEXTUAL_PREFIXES_PATH.exists():
            print(f"⚠️  Contextual prefixes file not found: {CONTEXTUAL_PREFIXES_PATH}")
            return 0
        ...
        print(f"📖 Applied {applied} contextual prefixes to sections")
        return applied
